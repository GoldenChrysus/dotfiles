...
# https://dev.to/nickymeuleman/using-graphical-user-interfaces-like-cypress-in-wsl2-249j
# export DISPLAY=192.168.80.1:0.0

eval `ssh-agent >/dev/null`
ssh-add ~/keys/chesshq/aws/patrick.pem >/dev/null 2>&1
ssh-add ~/keys/chesshq/vultr/chesshq >/dev/null 2>&1
. "$HOME/.cargo/env"
